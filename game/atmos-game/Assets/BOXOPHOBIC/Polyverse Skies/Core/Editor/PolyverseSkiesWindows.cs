...
{
    [MenuItem("Window/BOXOPHOBIC/Polyverse Skies/Publisher Page", false, 2000)]
    public static void Publisher()
    {
        Application.OpenURL("https://assetstore.unity.com/publishers/20529");
    }

    [MenuItem("Window/BOXOPHOBIC/Polyverse Skies/Discord Server", false, 2001)]
    public static void Discord()
    {
        Application.OpenURL("https://discord.com/invite/znxuXET");
    }

    [MenuItem("Window/BOXOPHOBIC/Polyverse Skies/Documentation", false, 2002)]
    ...
    [MenuItem("Window/BOXOPHOBIC/Polyverse Skies/Changelog", false, 2003)]
