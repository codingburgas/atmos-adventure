    ...
    <div className="hidden desktop:h-screen desktop:block">
      ...
      <div className="ml-32">
        <div className="flex flex-row justify-center items-center mt-20 extra:mt-0 el:!mt-10">
          <div>
            <div
              className="nuclea:bg-gradient-to-r from-[#687CC9] to-[#AA7DD0] dust:bg-[#F67E0F] text-transparent bg-clip-text text-xl font-serif font-bold extra:text-3xl"
              data-aos="fade-right"
              data-aos-duration="1500"
            >
            ...
            <h1
              className="font-serif font-bold text-5xl extra:text-6xl nuclea:text-[#111] dust:text-[#F6620F]"
              data-aos="fade-right"
              data-aos-duration="1500"
            >
          ...
          <div
            className="w-[350%] extra:w-[300%] el:!w-[60%] select-none"
            data-aos="fade-left"
            data-aos-duration="1500"
          >
        ...
        <div
          className="nuclea:bg-[#5F57E2] dust:bg-[#F6A70F] w-[25%] text-white rounded-full text-center py-3 font-serif font-bold text-2xl mt-5 el:w-[20%] xl:!w-[15%] xl:!mt-[-3%] extraXl:ml-16"
          data-aos="fade-right"
          data-aos-duration="1500"
        >
          <a
