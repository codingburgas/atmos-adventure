  ...
  return (
    <div className="bg-[url('https://i.imgur.com/j4BLlbk.png')] h-[250vh] bg-no-repeat bg-cover z-50 w-screen mt-16 el:h-[160vh]">
      ...
      <div className="flex flex-col justify-between items-center mt-10 el:flex-row el:justify-around el:mt-24">
        <div
          className="h-[40vh] w-[30vh] rounded-lg bg-[#466476] opacity-1 mb-20 z-0 flex flex-col justify-evenly items-center text-white el:mb-0"
          data-aos="fade-down"
          data-aos-duration="1500"
        >
        ...
        <div
          className="h-[40vh] w-[30vh] rounded-lg bg-[#466476] opacity-1 z-0 flex flex-col justify-evenly items-center text-white el:mb-0"
          data-aos="fade-down"
          data-aos-duration="1500"
        >
          <h1 className="font-raleway font-medium text-4xl">Downloads</h1>
